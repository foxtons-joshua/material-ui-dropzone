...
var styles = function styles(_ref) {
  ...
  return {
    ...
    image: {
      ...
      width: 'initial',
      maxWidth: '100%',
      color: palette === null || palette === void 0 || (_palette$text = palette.text) === null || _palette$text === void 0 ? void 0 : _palette$text.primary,
...
var styles$1 = function styles(theme) {
  ...
  return {
    successAlert: {
      backgroundColor: theme === null || theme === void 0 || (_theme$palette = theme.palette) === null || _theme$palette === void 0 || (_theme$palette = _theme$palette.success) === null || _theme$palette === void 0 ? void 0 : _theme$palette.main
    },
    errorAlert: {
      backgroundColor: theme === null || theme === void 0 || (_theme$palette2 = theme.palette) === null || _theme$palette2 === void 0 || (_theme$palette2 = _theme$palette2.error) === null || _theme$palette2 === void 0 ? void 0 : _theme$palette2.main
    },
    infoAlert: {
      backgroundColor: theme === null || theme === void 0 || (_theme$palette3 = theme.palette) === null || _theme$palette3 === void 0 || (_theme$palette3 = _theme$palette3.info) === null || _theme$palette3 === void 0 ? void 0 : _theme$palette3.main
    },
    warningAlert: {
      backgroundColor: theme === null || theme === void 0 || (_theme$palette4 = theme.palette) === null || _theme$palette4 === void 0 || (_theme$palette4 = _theme$palette4.warning) === null || _theme$palette4 === void 0 ? void 0 : _theme$palette4.main
    },
    message: {
      display: 'flex',
      alignItems: 'center',
      '& > svg': {
        marginRight: theme === null || theme === void 0 || (_theme$spacing = theme.spacing) === null || _theme$spacing === void 0 ? void 0 : _theme$spacing.call(theme, 1)
      }
    },
    icon: {
      fontSize: 20,
...
var styles$2 = function styles(_ref) {
  ...
  return {
    ...
    root: {
      ...
      width: '100%',
      minHeight: '250px',
      backgroundColor: palette === null || palette === void 0 || (_palette$background = palette.background) === null || _palette$background === void 0 ? void 0 : _palette$background.paper,
      border: 'dashed',
    ...
    active: {
      ...
      backgroundImage: "repeating-linear-gradient(-45deg, ".concat(palette === null || palette === void 0 || (_palette$background2 = palette.background) === null || _palette$background2 === void 0 ? void 0 : _palette$background2.paper, ", ").concat(palette === null || palette === void 0 || (_palette$background3 = palette.background) === null || _palette$background3 === void 0 ? void 0 : _palette$background3.paper, " 25px, ").concat(palette === null || palette === void 0 ? void 0 : palette.divider, " 25px, ").concat(palette === null || palette === void 0 ? void 0 : palette.divider, " 50px)"),
      backgroundSize: '150% 100%',
      border: 'solid',
      borderColor: palette === null || palette === void 0 || (_palette$primary = palette.primary) === null || _palette$primary === void 0 ? void 0 : _palette$primary.light
    },
    invalid: {
      // eslint-disable-next-line max-len
      backgroundImage: "repeating-linear-gradient(-45deg, ".concat(palette === null || palette === void 0 || (_palette$error = palette.error) === null || _palette$error === void 0 ? void 0 : _palette$error.light, ", ").concat(palette === null || palette === void 0 || (_palette$error2 = palette.error) === null || _palette$error2 === void 0 ? void 0 : _palette$error2.light, " 25px, ").concat(palette === null || palette === void 0 || (_palette$error3 = palette.error) === null || _palette$error3 === void 0 ? void 0 : _palette$error3.dark, " 25px, ").concat(palette === null || palette === void 0 || (_palette$error4 = palette.error) === null || _palette$error4 === void 0 ? void 0 : _palette$error4.dark, " 50px)"),
      borderColor: palette === null || palette === void 0 || (_palette$error5 = palette.error) === null || _palette$error5 === void 0 ? void 0 : _palette$error5.main
    },
    textContainer: {
      textAlign: 'center'
    },
...
var DropzoneArea = /*#__PURE__*/function (_React$PureComponent) {
  function DropzoneArea() {
    ...
    _defineProperty(_this, "loadInitialFiles", /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime.mark(function _callee2() {
...
process.env.NODE_ENV !== "production" ? DropzoneArea.propTypes = _objectSpread(_objectSpread({}, DropzoneAreaBase$1.propTypes), {}, {
...
process.env.NODE_ENV !== "production" ? DropzoneDialogBase.propTypes = _objectSpread$1(_objectSpread$1({}, DropzoneAreaBase$1.propTypes), {}, {
...
process.env.NODE_ENV !== "production" ? DropzoneDialog.propTypes = _objectSpread$2(_objectSpread$2({}, DropzoneDialogBase.propTypes), {}, {
  /** Clear uploaded files when component is unmounted. */
  clearOnUnmount: PropTypes.bool,
  /** Maximum number of files that can be loaded into the dropzone. */
  filesLimit: PropTypes.number,
